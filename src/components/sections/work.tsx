    ...
    <section id="work" className="bg-secondary py-24 sm:py-32">
      <div className="mx-auto max-w-6xl px-6 lg:px-8">
        <div className="mx-auto max-w-2xl text-center">
          <h2 className="font-headline text-3xl font-bold uppercase tracking-tight text-[#000080] sm:text-4xl">Our Work</h2>
        ...
        <div className="mt-16 grid grid-cols-1 gap-8 sm:grid-cols-2 lg:grid-cols-3">
          {works.map((work) => (
            <Card key={work.id} className="group overflow-hidden rounded-lg border-2 border-transparent transition-all duration-300 hover:border-[#FF0000] hover:shadow-2xl">
